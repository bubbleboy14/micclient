...
class MICSClient(Named):
    def __init__(self, host, port, verbose=False, name="anonymous", ai="", depth=1, book="", random=1, tiny=False, opponent=False, invisible=False, game=None, rofflim=3, dbuntil=30):
        setScale(not tiny)
